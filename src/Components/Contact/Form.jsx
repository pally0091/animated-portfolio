...
const Form = () => {
  useEffect(() => {
    ...
    const configureIframe = () => {
      const iframe = document.getElementById("JotFormIFrame-233492523381456");
      if (iframe) {
    ...
    const addMessageEventListener = () => {
      const eventListener = window.addEventListener || window.attachEvent;
      eventListener("message", handleIFrameMessage, false);
    };
  ...
  return (
    <div>
      <iframe
        id="JotFormIFrame-233492523381456"
        title="Modern Contact Form"
        allowtransparency="true"
        allowfullscreen="true"
        allow="geolocation; microphone; camera"
        src="https://form.jotform.com/233492523381456"
        frameBorder="2"
        style={{
          minWidth: "100%",
          maxWidth: "100%",
